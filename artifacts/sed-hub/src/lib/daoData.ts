...
export const DAO_PROPOSALS: Proposal[] = [
  ...
  {
    id: "dao-004",
    title: "Деплой собственного пула на Polygon (thirdweb + Safe)",
    description: "Задеплоить SX Fund Pool контракт на Polygon через thirdweb. Получатель выплат — Safe 2-of-3. Это Фаза 1: собственный пул для накопления истории сделок перед будущей подачей POP в Centrifuge.",
    category: "infra",
    status: "pending",
    quorum: 3,
    deadline: "2026-07-01",
  ...
  {
    id: "dao-008",
    title: "Деплой SXFToken (ERC-20, 1B supply)",
    description: "Задеплоить SXFToken на Polygon (ERC-20, 1 000 000 000 supply). Owner = Gnosis Safe. Используется для governance и распределения yield. Требует наличия Safe.",
    category: "infra",
    status: "pending",
    quorum: 2,
    deadline: "2026-07-01",
  ...
  {
    id: "dao-009",
    title: "Деплой RWAMarketplace (buyback & burn)",
    description: "Задеплоить RWAMarketplace контракт на Polygon. Обеспечивает buyback NFT и burn механизм при погашении сделки. Owner = Gnosis Safe. Требует наличия NFT контракта.",
    category: "infra",
    status: "pending",
    quorum: 2,
    deadline: "2026-07-15",
    blockedBy: ["dao-001", "dao-002"],
  },
  {
    id: "dao-007",
    title: "Подача POP в Centrifuge (Фаза 4)",
    description: "Подать Pool Onboarding Proposal (POP) в Centrifuge DAO после накопления 6–12 месяцев истории сделок и объёма $250K+ TVL. Это финальная фаза стратегии гибридного пула.",
    category: "governance",
    status: "pending",
    quorum: 3,
    deadline: "2027-06-01",
